...
contain maximum N candies when JAR is full. At any point of time. JAR can have M number of Candies 
...
'''
total_candies = 10     #N=10

no_of_candies = int(input("Enter number of candies="))

if(no_of_candies>=1 and no_of_candies<=5):   #k=<5
    print("candies sold=",no_of_candies) #give number of Candies sold
    print("candies remaining in jar=",total_candies - no_of_candies) #updated number of Candies in JAR.
