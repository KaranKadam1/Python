...
should be written to STDOUT. For example , if N=16, the 16th term in the series is 2187, so only value 2187
...
if(n%2 !=0):
    print(f"{n} term of series is {str(int(odd/2))}")
else:
    print(f"{n} term of series is {str(int(even/3))}")